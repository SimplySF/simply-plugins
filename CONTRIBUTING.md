...
Utilities for working with Salesforce Communities (Experience Cloud sites). This package is part of the [`simply-node`](https://github.com/SimplySF/simply-node) monorepo.
