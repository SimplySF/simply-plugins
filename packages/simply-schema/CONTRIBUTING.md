# Contributing to @simplysf/simply-schema

Utilities for visualizing Salesforce schema. This package is part of the [`simply-plugins`](https://github.com/SimplySF/simply-plugins) monorepo.
