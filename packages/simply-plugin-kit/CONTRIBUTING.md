...
Shared oclif command building blocks for SimplySF Salesforce CLI plugins. This package is part of the [`simply-plugins`](https://github.com/SimplySF/simply-plugins) monorepo.
