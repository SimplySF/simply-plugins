# Contributing to @simplysf/simply-data

Utilities for working with data. This package is part of the [`simply-plugins`](https://github.com/SimplySF/simply-plugins) monorepo.
...
This package also regenerates its README automatically on version bump, via its `version` script — but run it by hand and commit the result with your change rather than waiting for the release.
