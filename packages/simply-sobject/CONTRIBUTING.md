# Contributing to @simplysf/simply-sobject

Utilities for working with SObjects. This package is part of the [`simply-plugins`](https://github.com/SimplySF/simply-plugins) monorepo.
