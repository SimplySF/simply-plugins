# Contributing to @simplysf/simply-permissions

Utilities for working with permissions. This package is part of the [`simply-plugins`](https://github.com/SimplySF/simply-plugins) monorepo.
