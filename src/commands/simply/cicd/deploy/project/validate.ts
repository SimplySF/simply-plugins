...
const messages = Messages.loadMessages('@simplysf/simply-cicd', 'simply.cicd.deploy.project.validate');

/** Validates deployment configuration files for a project deployment. */
export default class DeployProjectValidate extends SfCommand<void> {
  ...
  public async run(): Promise<void> {
    const { flags } = await this.parse(DeployProjectValidate);
